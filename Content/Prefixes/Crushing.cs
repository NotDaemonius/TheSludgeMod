...
public class Crushing : ModPrefix
{
    ...
    public override void ModifyValue(ref float valueMult) => valueMult *= 1.3225f;
}
...
public class CrushingTooltip : GlobalItem
{
    ...
    {
        if (item.prefix != ModContent.PrefixType<Crushing>()) return;
    ...
    public override void ModifyTooltips(Item item, List<TooltipLine> tooltips)
    {
        ...
        {
            var line = new TooltipLine(Mod, "PrefixArmorPenetration", "+6 armor penetration") {IsModifier = true};
