...
namespace TheSludgeMod.Content.Items.Accessories.VoodooDolls
{
    ...
    public class DryadVoodooDoll : ModItem
    {
        ...
        {
            player.GetModPlayer<DryadDollPlayer>().voodooDryad = true;
        }
    }
    public class DryadDollNPC : GlobalNPC
    {
        ...
        {
            if (npc.type == NPCID.Dryad && player.GetModPlayer<DryadDollPlayer>().voodooDryad)
                return true;
        ...
        public override bool? CanBeHitByProjectile(NPC npc, Projectile projectile)
        {
            ...
            if (owner.GetModPlayer<DryadDollPlayer>().voodooDryad)
                return true;
