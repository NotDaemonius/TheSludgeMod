...
namespace TheSludgeMod.Content.Items.Accessories.VoodooDolls
{
    ...
    public class CyborgVoodooDoll : ModItem
    {
        ...
        {
            player.GetModPlayer<CyborgDollPlayer>().voodooCyborg = true;
        }
    }
    public class CyborgDollNPC : GlobalNPC
    {
        ...
        {
            if (npc.type == NPCID.Cyborg && player.GetModPlayer<CyborgDollPlayer>().voodooCyborg)
                return true;
        ...
        public override bool? CanBeHitByProjectile(NPC npc, Projectile projectile)
        {
            ...
            if (owner.GetModPlayer<CyborgDollPlayer>().voodooCyborg)
                return true;
