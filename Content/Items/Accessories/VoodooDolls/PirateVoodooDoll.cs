...
namespace TheSludgeMod.Content.Items.Accessories.VoodooDolls
{
    ...
    public class PirateVoodooDoll : ModItem
    {
        ...
        {
            player.GetModPlayer<PirateDollPlayer>().voodooPirate = true;
        }
    }
    public class PirateDollNPC : GlobalNPC
    {
        ...
        {
            if (npc.type == NPCID.Pirate && player.GetModPlayer<PirateDollPlayer>().voodooPirate)
                return true;
        ...
        public override bool? CanBeHitByProjectile(NPC npc, Projectile projectile)
        {
            ...
            if (owner.GetModPlayer<PirateDollPlayer>().voodooPirate)
                return true;
