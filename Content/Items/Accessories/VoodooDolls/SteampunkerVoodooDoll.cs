...
namespace TheSludgeMod.Content.Items.Accessories.VoodooDolls
{
    ...
    public class SteampunkerVoodooDoll : ModItem
    {
        ...
        {
            player.GetModPlayer<SteampunkerDollPlayer>().voodooSteampunker = true;
        }
    }
    public class SteampunkerDollNPC : GlobalNPC
    {
        ...
        {
            if (npc.type == NPCID.Steampunker && player.GetModPlayer<SteampunkerDollPlayer>().voodooSteampunker)
                return true;
        ...
        public override bool? CanBeHitByProjectile(NPC npc, Projectile projectile)
        {
            ...
            if (owner.GetModPlayer<SteampunkerDollPlayer>().voodooSteampunker)
                return true;
