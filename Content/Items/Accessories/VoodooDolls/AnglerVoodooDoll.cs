...
namespace TheSludgeMod.Content.Items.Accessories.VoodooDolls
{
    ...
    public class AnglerVoodooDoll : ModItem
    {
        ...
        {
            player.GetModPlayer<AnglerDollPlayer>().voodooAngler = true;
        }
    }
    public class AnglerDollNPC : GlobalNPC
    {
        ...
        {
            if (npc.type == NPCID.Angler && player.GetModPlayer<AnglerDollPlayer>().voodooAngler)
                return true;
        ...
        public override bool? CanBeHitByProjectile(NPC npc, Projectile projectile)
        {
            ...
            if (owner.GetModPlayer<AnglerDollPlayer>().voodooAngler)
                return true;
