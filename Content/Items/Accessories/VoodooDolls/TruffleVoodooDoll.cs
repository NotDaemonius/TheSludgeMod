...
namespace TheSludgeMod.Content.Items.Accessories.VoodooDolls
{
    ...
    public class TruffleVoodooDoll : ModItem
    {
        ...
        {
            player.GetModPlayer<TruffleDollPlayer>().voodooTruffle = true;
        }
    }
    public class TruffleDollNPC : GlobalNPC
    {
        ...
        {
            if (npc.type == NPCID.Truffle && player.GetModPlayer<TruffleDollPlayer>().voodooTruffle)
                return true;
        ...
        public override bool? CanBeHitByProjectile(NPC npc, Projectile projectile)
        {
            ...
            if (owner.GetModPlayer<TruffleDollPlayer>().voodooTruffle)
                return true;
