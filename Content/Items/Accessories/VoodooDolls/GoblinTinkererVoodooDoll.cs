...
namespace TheSludgeMod.Content.Items.Accessories.VoodooDolls
{
    ...
    public class GoblinTinkererVoodooDoll : ModItem
    {
        ...
        {
            player.GetModPlayer<GoblinTinkererDollPlayer>().voodooGoblinTinkerer = true;
        }
    }
    public class GoblinTinkererDollNPC : GlobalNPC
    {
        ...
        {
            if (npc.type == NPCID.GoblinTinkerer && player.GetModPlayer<GoblinTinkererDollPlayer>().voodooGoblinTinkerer)
                return true;
        ...
        public override bool? CanBeHitByProjectile(NPC npc, Projectile projectile)
        {
            ...
            if (owner.GetModPlayer<GoblinTinkererDollPlayer>().voodooGoblinTinkerer)
                return true;
