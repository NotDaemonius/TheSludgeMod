...
namespace TheSludgeMod.Content.Items.Accessories.VoodooDolls
{
    ...
    public class TavernkeepVoodooDoll : ModItem
    {
        ...
        {
            player.GetModPlayer<TavernkeepDollPlayer>().voodooTavernkeep = true;
        }
    }
    public class TavernkeepDollNPC : GlobalNPC
    {
        ...
        {
            if (npc.type == NPCID.DD2Bartender && player.GetModPlayer<TavernkeepDollPlayer>().voodooTavernkeep)
                return true;
        ...
        public override bool? CanBeHitByProjectile(NPC npc, Projectile projectile)
        {
            ...
            if (owner.GetModPlayer<TavernkeepDollPlayer>().voodooTavernkeep)
                return true;
