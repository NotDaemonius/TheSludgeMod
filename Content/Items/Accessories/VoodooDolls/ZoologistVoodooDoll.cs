...
namespace TheSludgeMod.Content.Items.Accessories.VoodooDolls
{
    ...
    public class ZoologistVoodooDoll : ModItem
    {
        ...
        {
            player.GetModPlayer<ZoologistDollPlayer>().voodooZoologist = true;
        }
    }
    public class ZoologistDollNPC : GlobalNPC
    {
        ...
        {
            if (npc.type == NPCID.BestiaryGirl && player.GetModPlayer<ZoologistDollPlayer>().voodooZoologist)
                return true;
        ...
        public override bool? CanBeHitByProjectile(NPC npc, Projectile projectile)
        {
            ...
            if (owner.GetModPlayer<ZoologistDollPlayer>().voodooZoologist)
                return true;
