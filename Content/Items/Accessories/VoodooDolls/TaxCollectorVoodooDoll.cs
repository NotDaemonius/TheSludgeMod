...
namespace TheSludgeMod.Content.Items.Accessories.VoodooDolls
{
    ...
    public class TaxCollectorVoodooDoll : ModItem
    {
        ...
        {
            player.GetModPlayer<TaxCollectorDollPlayer>().voodooTaxCollector = true;
        }
    }
    public class TaxCollectorDollNPC : GlobalNPC
    {
        ...
        {
            if (npc.type == NPCID.TaxCollector && player.GetModPlayer<TaxCollectorDollPlayer>().voodooTaxCollector)
                return true;
        ...
        public override bool? CanBeHitByProjectile(NPC npc, Projectile projectile)
        {
            ...
            if (owner.GetModPlayer<TaxCollectorDollPlayer>().voodooTaxCollector)
                return true;
