...
namespace TheSludgeMod.Content.Items.Accessories.VoodooDolls
{
    ...
    public class WitchDoctorVoodooDoll : ModItem
    {
        ...
        {
            player.GetModPlayer<WitchDoctorDollPlayer>().voodooWitchDoctor = true;
        }
    }
    public class WitchDoctorDollNPC : GlobalNPC
    {
        ...
        {
            if (npc.type == NPCID.WitchDoctor && player.GetModPlayer<WitchDoctorDollPlayer>().voodooWitchDoctor)
                return true;
        ...
        public override bool? CanBeHitByProjectile(NPC npc, Projectile projectile)
        {
            ...
            if (owner.GetModPlayer<WitchDoctorDollPlayer>().voodooWitchDoctor)
                return true;
