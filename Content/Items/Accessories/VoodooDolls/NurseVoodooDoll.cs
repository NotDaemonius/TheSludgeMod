...
namespace TheSludgeMod.Content.Items.Accessories.VoodooDolls
{
    ...
    public class NurseVoodooDoll : ModItem
    {
        ...
        {
            player.GetModPlayer<NurseDollPlayer>().voodooNurse = true;
        }
    }
    public class NurseDollNPC : GlobalNPC
    {
        ...
        {
            if (npc.type == NPCID.Nurse && player.GetModPlayer<NurseDollPlayer>().voodooNurse)
                return true;
        ...
        public override bool? CanBeHitByProjectile(NPC npc, Projectile projectile)
        {
            ...
            if (owner.GetModPlayer<NurseDollPlayer>().voodooNurse)
                return true;
