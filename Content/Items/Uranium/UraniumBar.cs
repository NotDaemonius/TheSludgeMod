...
namespace TheSludgeMod.Content.Items.Uranium
{
	public class UraniumBar : ModItem
	{
		public override void SetStaticDefaults() 
		{
			...
			ItemTrader.ChlorophyteExtractinator.AddOption_OneWay(Type, 1, ItemID.PalladiumBar, 1);
		}
		public override void SetDefaults()
		{
			Item.DefaultToPlaceableTile(ModContent.TileType<UraniumBarTile>());
			Item.width = 20;
			Item.height = 20;
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient<UraniumOre>(3);
