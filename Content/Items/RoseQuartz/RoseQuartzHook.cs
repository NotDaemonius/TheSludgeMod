...
public class RoseQuartzHookProjectile : ModProjectile
{
    ...
    {
        if (!Main.dedServ) chainTexture = ModContent.Request<Texture2D>("TheSludgeMod/Content/Items/RoseQuartz/RoseQuartzHookChain");
    }

    public override void Unload() => chainTexture = null;
    ...
    public override bool? CanUseGrapple(Player player)
    {
        ...
        {
            if (p.owner == Main.myPlayer && p.type == Projectile.type) p.Kill();
        }
