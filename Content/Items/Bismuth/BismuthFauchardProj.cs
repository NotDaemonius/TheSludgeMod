...
public class BismuthFauchardProj : ModProjectile
{
    private const float MaxReach = 130f;
    private const int o = 18;
    ...
    public override void AI()
    {
        ...
        if (Projectile.ai[0] <= halfDuration) progress = Projectile.ai[0] / halfDuration;
        else progress = 1f - ((Projectile.ai[0] - halfDuration) / halfDuration);
