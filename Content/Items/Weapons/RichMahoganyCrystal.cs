...
{
    public class RichMahoganyCrystal : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<RichMahoganyCrystalProj>();
            Item.shootSpeed = 1f;

            Item.buffType = ModContent.BuffType<RichMahoganyCrystalBuff>();
