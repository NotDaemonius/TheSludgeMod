...
namespace TheSludgeMod.Content.Items.Weapons
{
	...
	public class ThePainframe : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.knockBack = 7f; // The knockback of your flail, this is dynamically adjusted in the projectile code.
			Item.width = 32; // Hitbox width of the item.
			Item.height = 32; // Hitbox height of the item.
			Item.damage = 135; // The damage of your flail, this is dynamically adjusted in the projectile code.
			Item.noUseGraphic = true; // This makes sure the item does not get shown when the player swings his hand
			Item.shoot = ModContent.ProjectileType<ThePainframeProjectile>(); // The flail projectile
			Item.shootSpeed = 16f; // The speed of the projectile measured in pixels per frame.
			Item.crit = 15;
			Item.UseSound = SoundID.Item1; // The sound that this item makes when used
			Item.rare = ItemRarityID.LightPurple; // The color of the name of your item
			Item.value = Item.sellPrice(gold: 5); // Sells for 1 gold 50 silver
