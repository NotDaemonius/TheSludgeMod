...
namespace TheSludgeMod.Content.Tiles
{
    public class MainframeRelicTile : ModTile
    {
        ...
        {
            _relicTexture = ModContent.Request<Texture2D>("TheSludgeMod/Content/Tiles/MainframeRelicTile");
        }
        ...
        public override void SpecialDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            for (float t = 0f; t < 1f; t += 355f / (678f * (float)Math.PI))
                spriteBatch.Draw(texture, drawPos + (TwoPi * t).ToRotationVector2() * (6f + offset * 2f), frame, effectColor, 0f, origin, 1f, effects, 0f);
        }
    }
}