...
public class MushroomSofaTile : ModTile
{
    public override void SetStaticDefaults() => this.SetUpSofa(ModContent.ItemType<MushroomSofa>(), true);
    ...
    public override void MouseOver(int i, int j) => FurnitureCommon.BenchMouseOver(i, j, ModContent.ItemType<MushroomSofa>());
