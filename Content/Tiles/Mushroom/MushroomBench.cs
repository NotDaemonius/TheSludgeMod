...
public class MushroomBenchTile : ModTile
{
    public override void SetStaticDefaults() => this.SetUpSofa(ModContent.ItemType<MushroomBench>(), true);
    ...
    public override void MouseOver(int i, int j) => FurnitureCommon.BenchMouseOver(i, j, ModContent.ItemType<MushroomBench>());
