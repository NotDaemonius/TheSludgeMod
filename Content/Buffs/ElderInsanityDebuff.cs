...
namespace TheSludgeMod.Content.Buffs
{
    public class ElderInsanityDebuff : ModBuff
    {
        ...
        {
            player.GetModPlayer<ElderInsanityPlayer>().elderInsanity = true;
        }
        public override void Update(NPC npc, ref int buffIndex)
        {
            npc.GetGlobalNPC<ElderInsanityNPC>().elderInsanity = true;
        }
    }
    public class ElderInsanityPlayer : ModPlayer
    {
        ...
        public override void PostUpdate()
        {
            ...
            if (damageAccumulator >= 1f)
            {
                ...
                Player.KillMe(new PlayerDeathReason { CustomReason = NetworkText.FromLiteral(Player.name + " succumbed to elder insanity.") }, dmg, 0);
