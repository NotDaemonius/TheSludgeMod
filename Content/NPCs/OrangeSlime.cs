...
namespace TheSludgeMod.Content.NPCs
{
    public class OrangeSlime : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if (NPC.velocity.Y < MaxJumpVelocity)
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new List<IBestiaryInfoElement> {
                ...
                new FlavorTextBestiaryInfoElement("Mods.TheSludgeMod.Bestiary.OrangeSlime")
            });
        }
        public override void ModifyNPCLoot(NPCLoot npcLoot)
        {
            npcLoot.Add(ItemDropRule.Common(ItemID.Gel, 1, 15, 25));
        }
