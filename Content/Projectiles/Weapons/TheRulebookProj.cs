...
public class TheRulebookProj : ModProjectile
{
    ...
    public override bool OnTileCollide(Vector2 oldVelocity)
    {
        ...
        if (Projectile.velocity.X != oldVelocity.X) Projectile.velocity.X = -oldVelocity.X * bounceDamping;
        if (Projectile.velocity.Y != oldVelocity.Y) Projectile.velocity.Y = -oldVelocity.Y * bounceDamping;
        ...
        if (hitHard) SoundEngine.PlaySound(SoundID.Dig, Projectile.position);
        return false;
    }
