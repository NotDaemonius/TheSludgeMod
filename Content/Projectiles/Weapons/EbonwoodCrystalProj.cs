...
public class EbonwoodCrystalProj : ModProjectile
{
    ...
    private bool CheckActive(Player owner)
    {
        ...
        {
            owner.ClearBuff(ModContent.BuffType<EbonwoodCrystalBuff>());
            Projectile.active = false;
            return false;
        }

        if (owner.HasBuff(ModContent.BuffType<EbonwoodCrystalBuff>())) Projectile.timeLeft = 2;
        return true;
    }
    ...
    private void FireLeaf(NPC target)
    {
        ...
        Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, direction * LeafSpeed, ModContent.ProjectileType<EbonwoodTreeWandProj>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
    }
}