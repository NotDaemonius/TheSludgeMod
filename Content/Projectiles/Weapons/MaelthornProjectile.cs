...
namespace TheSludgeMod.Content.Projectiles.Weapons
{
	...
	{
		private const string ChainTexturePath = "TheSludgeMod/Content/Projectiles/Weapons/MaelthornChain"; // The folder path to the flail chain sprite
		private const string ChainTextureExtraPath = "TheSludgeMod/Content/Projectiles/Weapons/MaelthornChainExtra";  // This texture and related code is optional and used for a unique effect
		...
		public override void AI() {
			...
			*/
			...
			if (Main.rand.NextBool(dustRate))
				Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 39, 0f, 0f, 150, default(Color), 1.3f);
		}
