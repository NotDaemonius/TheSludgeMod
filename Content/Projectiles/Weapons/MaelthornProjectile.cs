...
{
	public class MaelthornProjectile : ModProjectile
	{
		private const string ChainTexturePath = "TheSludgeMod/Content/Projectiles/Weapons/MaelthornChain"; 
		private const string ChainTextureExtraPath = "TheSludgeMod/Content/Projectiles/Weapons/MaelthornChainExtra"; 
		...
		public override void AI() 
		{
			...
			float maxRetractSpeed = 8f;
			float forcedRetractAcceleration = 5f;
			float maxForcedRetractSpeed = 12f;
					...
					shouldSwitchToRetracting |= Projectile.Distance(mountedCenter) >= maxLaunchLength;
						...
						if (player.controlUseItem)
						{
							...
							for (int i = 0; i < numberProjectiles; i++) 
							{
								...
								Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, perturbedSpeed, 374, 40, Projectile.knockBack, Main.myPlayer);
							}
						}
			...
			if (Main.rand.NextBool(dustRate)) Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.JungleGrass, 0f, 0f, 150, default(Color), 1.3f);
		}
