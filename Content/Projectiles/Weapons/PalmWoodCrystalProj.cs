...
public class PalmWoodCrystalProj : ModProjectile
{
    ...
    private bool CheckActive(Player owner)
    {
        ...
        {
            owner.ClearBuff(ModContent.BuffType<PalmWoodCrystalBuff>());
            Projectile.active = false;
            return false;
        }

        if (owner.HasBuff(ModContent.BuffType<PalmWoodCrystalBuff>())) Projectile.timeLeft = 2;
        return true;
    }
    ...
    private void FireLeaf(NPC target)
    {
        ...
        Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, direction * LeafSpeed, ModContent.ProjectileType<PalmWoodTreeWandProj>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
    }
}